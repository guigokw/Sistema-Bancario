...
public class Banco {
    ...
    public void adicionarCliente() throws IdDoClienteDuplicadoException, FuncionarioNaoEncontradoException, DateTimeParseException {
        if (listaDeFuncionarios.isEmpty()) {
    ...
    public void removerCliente() throws ClienteNaoEncontradoException, FuncionarioNaoEncontradoException {
    ...
    public void adicionarContaDoCliente() throws ClienteNaoEncontradoException, IllegalArgumentException, FuncionarioNaoEncontradoException {
        if (listaDeFuncionarios.isEmpty()) {
            System.out.println("nao foi possivel realizar a operacao pois não há nenhum funcionario registrado no banco");
        } else {
            System.out.print("qual o id do funcionario que ira adicionar uma conta ao cliente?");
            int idDoFuncionario = input.nextInt();
    ...
    public void bloquearConta() throws ClienteNaoEncontradoException, ContaNaoEncontradaException, FuncionarioNaoEncontradoException {
        if (listaDeFuncionarios.isEmpty()) {
    ...
    public void encerrarConta() throws ClienteNaoEncontradoException, ContaNaoEncontradaException, FuncionarioNaoEncontradoException {
        if (listaDeFuncionarios.isEmpty()) {
    ...
    public void adicionarCaixaEletronico() throws CaixaDuplicadoException, IllegalArgumentException, FuncionarioNaoEncontradoException {
        if (listaDeFuncionarios.isEmpty()) {
    ...
    public void removerCaixaEletronico() throws CaixaEletronicoNaoEncontradoException, FuncionarioNaoEncontradoException {
