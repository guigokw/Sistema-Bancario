public enum TipoOperacao {
    ...
    EXTRATO("Um extrato bancário é um documento que detalla todas as transações realizadas numa conta bancária durante um determinado período, como saques, depósitos, transferências, pagamentos, juros e taxas. Ele é essencial para controlar as finanças, verificar a precisão das operações e identificar possíveis erros ou cobranças indevidas");
